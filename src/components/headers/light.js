...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
   ...
   * //<NavLink href="/about-htc">About</NavLink>
  ...
  const defaultLinks = [
    <NavLinks key={1}>
      ...
      <NavLink href="https://blog.hertechconnect.com/">Blog</NavLink>
      <NavLink href="https://forms.gle/4ptsui5h8k72AoQVA" target="_blank">User Survey</NavLink>
